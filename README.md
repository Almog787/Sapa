...
**Last Update / עדכון אחרון:** 20/02/2026 21:40 | **USD/ILS:** ₪3.118

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,638` | **שווי תיק** |
| **Daily Change** | `+1.49%` (₪2,673) | **שינוי יומי** |
| **Total Return** | `+38.38%` (₪50,382) | **תשואה מצטברת** |
