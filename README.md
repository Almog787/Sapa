...
**Last Update / עדכון אחרון:** 21/02/2026 00:33 | **USD/ILS:** ₪3.118

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,894` | **שווי תיק** |
| **Daily Change** | `+1.54%` (₪2,767) | **שינוי יומי** |
| **Total Return** | `+38.57%` (₪50,630) | **תשואה מצטברת** |
