...
**Last Update / עדכון אחרון:** 20/02/2026 18:50 | **USD/ILS:** ₪3.117

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪182,082` | **שווי תיק** |
| **Daily Change** | `+1.78%` (₪3,191) | **שינוי יומי** |
| **Total Return** | `+38.76%` (₪50,865) | **תשואה מצטברת** |
